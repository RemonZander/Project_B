...
namespace Project_B_V2._0
{
    ...
    public struct RondleidingSettings(DateOnly Date, List<Tuple<TimeOnly, int>> Rondleidingen);
    ...
    /// <param name="Rondleidingen">this is the list of tuples where the date is the time notation of the tour and the int is the max amount of visitors</param>
    public struct RondleidingSettingsDayOfWeek(DayOfWeek Day, List<Tuple<TimeOnly, int>> Rondleidingen);
}
